...
"""autogenerated by genpy from NatRosPkg/forcePlates.msg. Do not edit."""
import codecs
import sys
...
bool isPartial
"""
  __slots__ = ['nForcePlates','forcePlates']
  _slot_types = ['int32','NatRosPkg/forcePlate[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(forcePlates, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.nForcePlates is None:
        self.nForcePlates = 0
  ...
  def serialize(self, buff):
    ...
    """
    try:
      _x = self.nForcePlates
      buff.write(_get_struct_i().pack(_x))
      length = len(self.forcePlates)
  ...
  def deserialize(self, str):
    ...
    try:
      if self.forcePlates is None:
        self.forcePlates = None
      end = 0
      start = end
      end += 4
      (self.nForcePlates,) = _get_struct_i().unpack(str[start:end])
      start = end
      end += 4
