...
"""autogenerated by genpy from NatRosPkg/skeletons.msg. Do not edit."""
import codecs
import sys
...
class skeletons(genpy.Message):
  _md5sum = "498018be8091f821b47e752d2a3c0e29"
  _type = "NatRosPkg/skeletons"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """int32 nSkeletons
skeleton[] skeletons
================================================================================
...
float64 w
"""
  __slots__ = ['nSkeletons','skeletons']
  _slot_types = ['int32','NatRosPkg/skeleton[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.nSkeletons,) = _get_struct_i().unpack(str[start:end])
      start = end
      end += 4
