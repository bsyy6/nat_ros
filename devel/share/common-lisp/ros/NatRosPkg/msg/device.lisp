...
(cl:defmethod cl:initialize-instance :after ((m <device>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'device)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name NatRosPkg-msg:<device> is deprecated: use NatRosPkg-msg:device instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <device>))
...
(cl:defmethod nChannels-val ((m <device>))
...
(cl:defmethod params-val ((m <device>))
...
(cl:defmethod channels-val ((m <device>))
